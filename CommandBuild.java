	...
	public void processCommand(ICommandSender var1, String[] coordinate) {
        ...
        {	
            ...
            {  
            	...
            	ruin.master.exploreThreads.add(new WorldGenCARuins( ruin, world,posX, posZ, 100, 1));	
            }
            else if ("wall".equalsIgnoreCase(coordinate[0]))
            {
            	wall=PopulatorGreatWall.instance;
            	wall.master.exploreThreads.add(new WorldGenGreatWall( wall, world, posX, posZ, 100, 1));         	            	
            }
            ...
            */
            else if ("city".equalsIgnoreCase(coordinate[0]))
            {
            	...
            	city.master.exploreThreads.add(new WorldGenWalledCity( city, world, posX, posZ, 100, 1));	
            }
            else if("undcity".equalsIgnoreCase(coordinate[0]))
            {
            	city=PopulatorWalledCity.instance;
            	WorldGeneratorThread wgt=new WorldGenUndergroundCity( city, world, posX, posZ, 100, 1);
